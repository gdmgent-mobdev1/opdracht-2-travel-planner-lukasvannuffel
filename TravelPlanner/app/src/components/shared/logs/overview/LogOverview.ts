...
import { defaultStyles, dialogStyles, tableStyles } from "@components/style/styles";
          ...
          ${logs.map((l) => {
            return html`
              <tr>
                ...
                ${showProject
                  ? html`<td>
                      <a href="/projects/${l.project?._id}" title="${l.project?.destination}">${l.project?.destination}</a>
                    </td>`
                  : ""}
